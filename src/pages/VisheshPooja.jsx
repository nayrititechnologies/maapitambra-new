...
export default function VisheshPooja() {
  useScrollToTop();
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <PageHero
        title={t("pages:visheshPooja.hero.title")}
        titleHighlight={t("pages:visheshPooja.hero.title_highlight")}
        description={t("pages:visheshPooja.hero.description")}
